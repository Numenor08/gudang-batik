...
class Transaction {
    static create(data, callback) {
        const { batik_id, type, quantity, supplier_id, distributor_id } = data;
        const query = 'INSERT INTO transactions (batik_id, type, quantity, supplier_id, distributor_id) VALUES (?, ?, ?, ?, ?)';
        db.query(query, [batik_id, type, quantity, supplier_id, distributor_id], callback);
    }
