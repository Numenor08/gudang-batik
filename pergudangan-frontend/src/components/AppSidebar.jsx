                                            ...
                                            {item.children ? (
                                                <Collapsible>
                                                    <CollapsibleTrigger asChild>
                                                        <SidebarMenuButton className={url.includes('/dashboard/management') ? "font-semibold" : ""} onClick={toggleManagement}>
                                                            <item.icon />
                                                            ...
                                                            {item.children.map((child) => (
                                                                <SidebarMenuSubItem key={child.title}>
                                                                    <SidebarMenuSubButton asChild>
                                                                        <Link className={child.url === url ? "font-semibold" : ""} to={child.url}>
                                                ...
                                                <SidebarMenuButton asChild>
                                                    <Link className={item.url === url ? "font-semibold" : ""} to={item.url}>
                                                        <item.icon />
                                                        <span>{item.title}</span>
                                                    </Link>
                                                </SidebarMenuButton>
